...
Date: 04-26-2025
Class: COMPSCI 1XD3 
About: GiftSpark Log in verification page that then redirects to landing page
-->
<?php
session_start();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        //password is retrieved for the given email
        ...
        if ($user) {
            ...
            //the entered password is checked with the hashed stored password
            if (password_verify($password, $db_password)) {
                ...
                //directed to landing page after successful login
                header("Location: ../events/landing_page.php");
                exit();
            } else {
