...
Date: 04-26-2025
Class: COMPSCI 1XD3 
About: GiftSpark landing page displaying all the upcoming events the user has planned
-->
<?php 
    session_start();
?>
    ...
    <?php
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            if ($select1_success) {
                ...
                //retrieves all the events with their details and the gifts as a comma separated string.
                ...
                if ($select2_success) {
                    ...
                    if ($select2_stmt->rowCount() < 1) {
                        ...
                        //creating the upcoming events table
                        ...
                        //for each event row returned, the appropriate details are entered into table
                        //and the edit and delete buttons are hidden form actions that redirect to the respective pages
                        while ($row = $select2_stmt->fetch()) {
                            echo 
                                "<tr style='background-color:$row[color_theme]'>
